...
ALTER TABLE Comments
	ADD (CONSTRAINT  R_22 FOREIGN KEY (UserID) REFERENCES Users(UserID));
...
ALTER TABLE Likes
	ADD (CONSTRAINT  R_23 FOREIGN KEY (UserID) REFERENCES Users(UserID));
...
ALTER TABLE QnA
	ADD (CONSTRAINT  R_20 FOREIGN KEY (BoardID) REFERENCES QnA(BoardID) ON DELETE SET NULL);



ALTER TABLE QnAComments
	ADD (CONSTRAINT  R_18 FOREIGN KEY (BoardID) REFERENCES QnA(BoardID));
