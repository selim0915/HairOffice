...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    if ($(this).scrollTop() > 90) {
      ...
      $('.slide-menu').css('background', 'rgba(0, 0, 0, 0.8)');
      $('.position').css('z-index', '1000');
      $('.right-content').css('z-index', '1000');
    } else {
      $('#header').removeClass('header-scrolled');
      $('.nav-menu a').css('color', 'black');
      $('.slide-menu').css('background', '#fff');
      $('.position').css('z-index', '900');
      $('.right-content').css('z-index', '900');
    }
  })
