						...
						<div class="insta-right">
							<div class="instagram-card">
								...
								<div class="instagram-card-content">
									...
									<p>
										<a class="user-comments"
											href="https://www.instagram.com/ritacq/">김동민</a> 지역이 어디인가요!?
									</p>
									<p class="comments">24시간전</p>
									<p>
										<a class="user-comments"
											href="https://www.instagram.com/ritacq/">신지혁</a> 오픈을 축하드립니다.
									</p>
		...
		<div class="gallery">
			...
			<div class="gallery-item" tabindex="0">
				...
				<div class="gallery-item-type">
					<span class="visually-hidden">Gallery</span><i class="far fa-clone"
						aria-hidden="true"></i>
				</div>
