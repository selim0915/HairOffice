...
<body>
	<div class="container">
		...
		<div id="searchResult_space">
			<c:set var="list" value="${requestScope.spaceList }" />
			<div id="period_space" style="float: right;">
				<b>FROM</b>&nbsp;&nbsp;&nbsp;&nbsp;
				${requestScope.start_date}&nbsp;&nbsp;&nbsp;&nbsp;<b>TO</b>&nbsp;&nbsp;&nbsp;&nbsp;${requestScope.end_date}
			</div>
			<table border="1">
				<tr>
					<td><b>지점명</b></td>
				...
				<c:forEach var="space" items="${list}">
					<tr>
						<td>${space.branchName}</td>
						<td>${space.spaceId }</td>
						<td>${space.spaceName }</td>
						<td>${space.codeName}</td>
						<td><c:choose>
